...
// Endpoint para obtener todas las carreras y sus materias
#[get("/api/carreras")]
async fn obtener_todas_carreras() -> impl Responder {
    let carreras = obtener_carreras();
    HttpResponse::Ok().json(carreras)
}

// Endpoint para obtener las materias de una carrera específica por su nombre
#[get("/api/carreras/{nombre}")]
...
async fn main() -> std::io::Result<()> {
    HttpServer::new(|| {
        App::new()
            .service(obtener_todas_carreras)
